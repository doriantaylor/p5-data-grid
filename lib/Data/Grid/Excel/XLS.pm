...
Data::Grid::Excel::XLS - The great new Data::Grid::Excel::XLS!
...
Perhaps a little code snippet.
    ...
    use Data::Grid::Excel::XLS;

    my $foo = Data::Grid::Excel::XLS->new();
    ...
