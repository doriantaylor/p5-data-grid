...
Data::Grid::Excel::XLSX - The great new Data::Grid::Excel::XLSX!
...
Perhaps a little code snippet.
    ...
    use Data::Grid::Excel::XLSX;

    my $foo = Data::Grid::Excel::XLSX->new();
    ...
